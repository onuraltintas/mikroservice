...
namespace Identity.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260914201411_AddTurkeyAdministrativeLocations")]
    partial class AddTurkeyAdministrativeLocations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduPlatform.Shared.Infrastructure.Middleware.AdminAuditRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AdminAuditRecords", "identity");
                });
            ...
            modelBuilder.Entity("Identity.Domain.Entities.IdempotencyRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("IdempotencyRecords", "identity");
                });
            ...
            modelBuilder.Entity("Identity.Domain.Entities.SystemConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Configurations", "identity");
                });
            ...
            modelBuilder.Entity("Identity.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("MfaLockedUntil")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Identity.Domain.Entities.District", b =>
                {
                    b.HasOne("Identity.Domain.Entities.Province", "Province")
                        .WithMany()
            ...
            modelBuilder.Entity("Identity.Domain.Entities.Institution", b =>
                {
                    b.HasOne("Identity.Domain.Entities.District", "DistrictReference")
                        .WithMany()
                    ...
                    b.Navigation("DistrictReference");
