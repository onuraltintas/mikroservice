                ...
                <div class="p-6 space-y-5">
                    @if (!createdUser()) {
                        ...
                        <div class="p-6 bg-green-50 dark:bg-green-900/10 rounded-xl border border-green-100 dark:border-green-800 text-center">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-300 mb-6">Kullanıcı hesabı oluşturuldu ve güvenli parola kurulum daveti <strong>{{ form.value.email }}</strong> adresine gönderildi.</p>
                            
                            <div class="bg-white dark:bg-gray-800 rounded-lg border border-green-200 dark:border-green-800 shadow-sm overflow-hidden">
                                <div class="px-4 py-2 border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50">
                                    <span class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Kurulum Daveti</span>
                                </div>
                                <div class="p-4 flex items-center justify-between">
                                    <span class="font-mono text-xl font-bold text-gray-800 dark:text-white tracking-widest">{{ createdUser()?.invitationSent ? 'Kurulum daveti gönderildi' : '' }}</span>
