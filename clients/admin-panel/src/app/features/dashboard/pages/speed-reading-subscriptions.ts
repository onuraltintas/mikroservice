...
export class SpeedReadingSubscriptionsComponent implements OnInit {
  ...
  savePlan(): void {
    ...
    const operation = this.planEditingId
      ? this.service.updateSubscriptionPlan(this.planEditingId, { name: this.planDraft.name, description: this.planDraft.description, price: Number(this.planDraft.price), isContactOnly: this.planDraft.isContactOnly, billingPeriod: this.planDraft.billingPeriod, durationDays: this.planDraft.durationDays, isActive: this.planDraft.isActive, isPublic: this.planDraft.isPublic, sortOrder: Number(this.planDraft.sortOrder), features })
  ...
  syncContactOnlyPrice(): void { if (this.planDraft.isContactOnly) this.planDraft.price = 0; }
  ...
  private emptyPlan(): SpeedReadingPlanRequest { return { name: '', description: '', slug: '', productId: '', price: 0, isContactOnly: false, billingPeriod: 'OneTime', durationDays: 180, isActive: true, isPublic: false, sortOrder: 0, features: [] }; }
