...
export class SpeedReadingCommunicationsComponent implements OnInit {
  ...
  private loadSelectedTab(): void {
    switch (this.selectedTab()) {
      case 'cms': if (this.canManageContent()) this.loadBlocks(); break;
  ...
  editPage(page: SpeedReadingCmsPage): void { this.cmsPageEditingId = page.id; this.cmsPageEditing.set(true); this.pageDraft = { title: page.title, slug: page.slug, content: page.content, isPublished: page.isPublished, scheduledPublishAt: page.scheduledPublishAt?.slice(0, 16) ?? null, seoSettings: page.seoSettings }; this.pageSeoJson = JSON.stringify(page.seoSettings, null, 2); }
