...
export class SpeedReadingCatalogComponent implements OnInit {
  ...
  loadExercises(): void { this.service.getExercises(this.contentPage).subscribe({ next: value => this.exercises.set(value), error: () => this.error.set('Egzersizler yüklenemedi.') }); }
